...
namespace FP_RSLUM
{
    class FP_RSLUM_setting : ModSettings
    {
        ...
        public void DoSettingsWindowContents(Rect canvas)
        {
            ...
            _Listing_Standard.GapLine(12f);
            _Listing_Standard.Label(Translator.Translate("FP_RSLUM_setting_AnimalEXPPerTick") + " : " + (AnimalEXPPerTick * 0.01).ToString("0.00"));    // Animals will get this amount of EXP every 10 seconds. default = 500
            AnimalEXPPerTick = (int)_Listing_Standard.Slider((float)AnimalEXPPerTick, 1f, 12000f);
            ...
            KillExpMult = (int)_Listing_Standard.Slider((float)KillExpMult, 1f, 1000f);
