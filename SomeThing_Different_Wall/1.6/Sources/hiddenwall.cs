...
namespace BombInWall
{
    ...
    public class BIWHidingWall_Comp : ThingComp
    {
        ...
        {
            // SoundDefOf.DropPod_Open.PlayOneShot(new TargetInfo(parent.Position, parent.Map, false)); deprecated
            Map map = parent.Map;
            parent.def.soundOpen.PlayOneShot(new TargetInfo(parent.Position, map));
